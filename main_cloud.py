    ...
    try:
        ...
        with open(filename, mode='w', newline='') as csvfile:
            ...
            for iteration in range(1, iterations + 1):
                ...
                log_attack(writer, siteid, lhost, rhost, datetime.now(), iteration, exploit_server_unrealircd.exploit(rhost, pre_attacks.IRC_PORT_CLOUD, pre_attacks.attacks.get('unrealircd')))
                log_attack(writer, siteid, lhost, rhost, datetime.now(), iteration, exploit_server_samba.exploit(rhost, pre_attacks.SAMBA_PORT_CLOUD, pre_attacks.attacks.get('samba')))
